...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo base_url() ?>assets/media/favicon.png" type="image/x-icon">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
    <script src="static/vendors/vue/vue.js" type="text/javascript"></script>
                ...
                <header class="header">
                    <div class="header-left">
                        <a href="<?php echo base_url() ?>home/index">
                            <img class="logo" src="<?php echo base_url() ?>assets/media/logo_acikbeyaz.png"
                                alt="grh-logo">
                        </a>
                    </div>

...
<body class="hold-transition sidebar-mini layout-fixed">0

  <div class="wrapper">

    <!-- Preloader -->
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="<?php echo base_url() ?>assets/logo_beyaz.png" alt="AdminLTELogo" height="60"
        width="60">
    </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img class="brand-image" href="#" src="<?php echo base_url() ?>assets/logo_beyaz.png">
        <h4>Umuttepe Turizm</h4>
      </a>
